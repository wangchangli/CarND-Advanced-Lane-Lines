...
![alt text](./output_images/calibration1_undist.jpg)
...
The code for my perspective transform includes a function called `perspective()`, which appears in the code cell  "3. Perspective transform" in ./examples/example.ipynb.  The `perspective()` function takes as inputs an image (`img`), as well as source (`src`) and destination (`dst`) points.  I chose the hardcode the source and destination points in the following manner:
...
I did this in the code cell "5. Calculate the radius of curvature"  in  ./examples/example.ipynb.
